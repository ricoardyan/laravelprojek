...
@section('content')
    <!-- Home section -->
    <div class="section-xl bg-image parallax" data-bg-src="{{asset('gambar_produk/60c38a1ae0eea.iPhone 13 -20210218075709.jpg')}}">
        ...
        <div class="container">
            <div class="row align-items-center col-spacing-50">
                <div class="col-12 col-lg-6">
                     <?php $img=DB::table('image_home')->inRandomOrder()->limit('1')->get(); ?>
                     @foreach($img as $im)
                    <img src="{{asset('gambar_produk')}}/{{$im->gambar_image}}" alt="">
                    @endforeach
                </div>
                <div class="col-12 col-lg-6">
    ...
    <div class="section-lg border-top">
        <div class="container">
            ...
            <div class="owl-carousel" data-owl-nav="true" data-owl-margin="30" data-owl-xs="1" data-owl-sm="1" data-owl-md="1" data-owl-lg="2" data-owl-xl="2">
                <?php $image=DB::table('image_home')->inRandomOrder()->get(); ?>
                @foreach($image as $img)
                <div>
                    <img src="{{asset('gambar_produk')}}/{{$img->gambar_image}}" alt="">
                </div>
               <!--  <div>
